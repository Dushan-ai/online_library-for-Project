...
<body>
  ...
  <div class= "main-content">
                    ...
                    <table style="width:100%">
                        ...
                        <tr>
                            <td colspan="3" style="width:90%">
                                ...
                                <p style="text-align:right; color: black;"><b>Price:</b> Rs. {{ $book->price }}</p>
                            </td>
                        </tr>
    ...
    <div style="display: flex; justify-content: flex-end; align-items: center;">
        <button type="submit" id="chat-button" name="submit" onclick="openAdd()"><i class="fa-duotone fa-solid fa-plus"></i></button>
    </div>
</div>
    ...
    <div id="AddForm" class="popup">
        <div id="popup-content" class="popup-content">
            <span class="close" onclick="closeAdd()">&times;</span>
                <h2 style="text-align:center"><b>Add New Book</b></h2>
                
            <form method="POST" action="{{ route('books.store') }}">
                @csrf
                <label for="title">Title:</label>
                <input type="text" id="title" style="border-radius:5%; text-align: left; flex: 1; padding: 10px; border: 1px solid #ccc; width: 100%;" name="title"  ><br><br>
                <label for="description">Description:</label><br>
                <textarea name="description" id="description" style="border-radius:5%; text-align: left; flex: 1; padding: 10px; border: 1px solid #ccc; width: 100%;height: 50px;"></textarea><br><br>
                <label for="type">Genre/Type:</label>
                <input type="text" id="type" style="border-radius:5%; text-align: left; flex: 1; padding: 10px; border: 1px solid #ccc; width: 100%;" name="type"  placeholder =""  ><br><br>
                <label for="price">Price:</label>
                <input type="number" id="price" style="border-radius:5%; text-align: left; flex: 1; padding: 10px; border: 1px solid #ccc; width: 100%;" name="price" placeholder ="Rs:"  ><br><br>
                <input type="submit" class="btn btn-primary" name="save" value="Save">  
                <input type="close" class="btn btn-secondary" value= "Cancel" onclick="closeAdd()">
            </form>
        </div>
    </div>
        ...
        <table style="text-align: justify; width:100%">
            ...
            <tr>
                <td colspan="3" style="width:90%">
                    ...
                    <p style="text-align:right; color: black;"><b>Price:</b> Rs. <span id="popup-price"></span></p>
                </td>
                                <th style="width:1%; text-align: right;">
                    <form method="POST" action="{{ route('books.destroy', $book->id) }}">
                            @csrf
